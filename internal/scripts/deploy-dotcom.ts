		...
		vars: {
			...
			...(previewId
				? {
						...
						// Previews trial the html-mode capture (see THUMBNAIL_RENDER_INLINE in types.ts);
						// staging and production stay on url mode until the spike settles.
						THUMBNAIL_RENDER_INLINE: '1',
						THUMBNAIL_RENDER_LIVE_CAPTURE: '1',

...
This repo contains a starter-kit for creating a fluid simulation background with [tldraw](https://github.com/tldraw/tldraw). The template demonstrates how to integrate WebGL shaders that respond to shape interactions on the canvas.

...
import { registerActionSchema } from '../types/AgentAction'
import { SimpleShapeIdSchema } from '../types/ids-schema'

// Add Detail Action
export const AddDetailAction = registerActionSchema(
	z
		.object({
...
// Align Action
export const AlignAction = registerActionSchema(
	z
		.object({
...
export const BringToFrontAction = registerActionSchema(
	z
		.object({
...
// Clear Action
export const ClearAction = registerActionSchema(
	z
		.object({
...
// Count Shapes Action
export const CountShapesAction = registerActionSchema(
	z
		.object({
...
// Country Info Action
export const CountryInfoAction = registerActionSchema(
	z
		.object({
...
// Create Action
export const CreateAction = registerActionSchema(
	z
		.object({
...
// Delete Action
export const DeleteAction = registerActionSchema(
	z
		.object({
...
// Distribute Action
export const DistributeAction = registerActionSchema(
	z
		.object({
...
// Label Action
export const LabelAction = registerActionSchema(
	z
		.object({
...
// Message Action
export const MessageAction = registerActionSchema(
	z
		.object({
...
// Move Action
export const MoveAction = registerActionSchema(
	z
		.object({
...
// Pen Action
export const PenAction = registerActionSchema(
	z
		.object({
			_type: z.literal('pen'),
			color: SimpleColor,
...
// Place Action
export const PlaceAction = registerActionSchema(
	z
		.object({
...
export const RandomWikipediaArticleAction = registerActionSchema(
	z
		.object({
...
// Resize Action
export const ResizeAction = registerActionSchema(
	z
		.object({
...
// Review Action
export const ReviewAction = registerActionSchema(
	z
		.object({
...
// Rotate Action
export const RotateAction = registerActionSchema(
	z
		.object({
...
// Send to Back Action
export const SendToBackAction = registerActionSchema(
	z
		.object({
...
// Set My View Action
export const SetMyViewAction = registerActionSchema(
	z
		.object({
...
// Stack Action
export const StackAction = registerActionSchema(
	z
		.object({
...
// Think Action
export const ThinkAction = registerActionSchema(
	z
		.object({
...
// Todo List Action
export const TodoListAction = registerActionSchema(
	z
		.object({
...
// Update Action
export const UpdateAction = registerActionSchema(
	z
		.object({
...
export const UnknownAction = registerActionSchema(
	z
		.object({

...
canvas.zoomToFit({ animation: { duration: 400 } })`,
	...
	'8 Ball Pool': `const tableX = 50, tableY = 80
...
canvas.zoomToFit({ animation: { duration: 400 } })`,
	...
	'Watercolor strokes': `const colors = ['blue', 'violet', 'red', 'orange', 'green', 'light-blue']
const centerX = 400
const centerY = 300
const petalCount = 6
const petalIds = []
...
const interval = setInterval(() => {
  ...
  createPetals(rotation, jStart, jEnd)
	...
	'Watercolor Spokes Sphere': `// 3D sphere with watercolor strokes radiating from center
...
canvas.zoomToFit({animation: {duration: 400}})`,
	...
	'Watercolor Mesh Sphere': `// 3D sphere with watercolor strokes connecting neighboring points

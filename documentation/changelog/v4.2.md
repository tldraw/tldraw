...
- Allow using custom socket implementations with `useSync` via a new `connect` option. ([#6859](https://github.com/tldraw/tldraw/pull/6859)) (thanks to [@Digital39999](https://github.com/Digital39999) for help on this one)

...
This guide explains how to improve a nugget draft based on its evaluation scores.
...
The improved draft should then be evaluated fresh using [EVALUATE.md](./EVALUATE.md). Use a separate evaluation pass—don't self-evaluate immediately after improving.

...
- packages/editor/src/lib/editor/Editor.ts - registerExternalContentHandler, registerExternalAssetHandler, putExternalContent, getAssetForExternalContent
- packages/editor/src/lib/editor/types/external-content.ts - Content type definitions and interfaces
- packages/tldraw/src/lib/defaultExternalContentHandlers.ts - Default handler implementations
- packages/tldraw/src/lib/ui/hooks/useClipboardEvents.ts - Clipboard event integration

...
- packages/editor/src/lib/editor/managers/TickManager/TickManager.ts - Frame loop management
- packages/editor/src/lib/editor/Editor.ts - Tick event dispatching
- packages/editor/src/lib/editor/tools/StateNode.ts - Event handler interface
- packages/editor/src/lib/editor/types/event-types.ts - Tick event type definitions
- packages/editor/src/lib/editor/managers/EdgeScrollManager/EdgeScrollManager.ts - Edge scrolling implementation
- packages/editor/src/lib/editor/managers/ScribbleManager/ScribbleManager.ts - Scribble animation implementation

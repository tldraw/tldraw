...
See [Edge scrolling](./edge-scrolling.md) for details on how these options affect behavior.
...
- packages/editor/src/lib/options.ts - TldrawOptions interface and defaultTldrawOptions
- packages/editor/src/lib/editor/Editor.ts - Options merged and stored on editor instance

## Related

- [Edge scrolling](./edge-scrolling.md) - Edge scroll options in detail
- [Camera system](./camera-system.md) - Camera-related options and behavior
- [Pages](./pages.md) - Multi-page system affected by maxPages option

...
function App() {
	return (
		<Tldraw
			shapeUtils={[ConfiguredArrowUtil, ConfiguredFrameUtil, ConfiguredNoteUtil]}
		/>
	)
}
```
...
- packages/tldraw/src/lib/defaultShapeUtils.ts - Default shape utility exports
- packages/tldraw/src/lib/shapes/ - Shape utility implementations
- packages/tlschema/src/shapes/ - Shape type definitions and validators
- packages/editor/src/lib/editor/shapes/group/GroupShapeUtil.tsx - Group shape (in editor package)

## Related

- [Shapes](./shapes.md) - Shape system architecture
- [Styles](./styles.md) - Style system for shape properties
- [Bindings](./bindings.md) - Arrow binding system
- [Custom shapes guide](../guides/custom-shapes.md) - Creating your own shapes

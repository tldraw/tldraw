  ...
  setInterval(() => {
      container.innerHTML = `<p>This editor has been (actually) running for ${((Date.now()-runTimeStart)/1000.0).toFixed(1)} seconds</p>`;
      container.innerHTML += `<p>This editor has been (virtually) running for ${((Date.now()-virtualRunTimeStart)/1000.0).toFixed(1)} seconds</p>`;
  }, 30);

 ...
 * @public
 */
export interface TLPersistentStorageTransactionOptions {
	/**
 ...
 * @public
 */
export interface TLPersistentStorageOnChangeCallbackProps {
	/**
...
export interface TLPersistentStorageGetChangesSinceResult<R extends UnknownRecord> {
	puts: Iterable<R>

...
// @internal (undocumented)
export const arrowheadValidator: T.Validator<
...
// @internal (undocumented)
export function CLIENT_FIXUP_SCRIPT(
	persistedStore: StoreSnapshot<TLRecord>
): StoreSnapshot<TLRecord>

// @internal (undocumented)
export const colorValidator: T.Validator<
	| 'black'
	| 'blue'
	| 'green'
	| 'grey'
...
// @internal (undocumented)
export const geoValidator: T.Validator<
	| 'arrow-down'
	| 'arrow-left'
	| 'arrow-right'
	| 'arrow-up'
...
// @internal (undocumented)
export const iconValidator: T.Validator<
	| 'activity'
	| 'airplay'
	| 'alert-circle'
	| 'alert-octagon'
...
export const InstancePresenceRecordType: RecordType<
	TLInstancePresence,
	'currentPageId' | 'instanceId' | 'userId' | 'userName'
>
...
// @public (undocumented)
export const TL_ARROWHEAD_TYPES: Set<
	'arrow' | 'bar' | 'diamond' | 'dot' | 'inverted' | 'none' | 'pipe' | 'square' | 'triangle'
>

// @public (undocumented)
export const TL_COLOR_TYPES: Set<
	| 'black'
	| 'blue'
	| 'green'
	| 'grey'
...
// @public (undocumented)
export const TL_ICON_TYPES: Set<
	| 'activity'
	| 'airplay'
	| 'alert-circle'
	| 'alert-octagon'
...
// @public (undocumented)
export const TL_STYLE_TYPES: Set<
	| 'align'
	| 'arrowheadEnd'
	| 'arrowheadStart'
	| 'color'
...
// @public (undocumented)
export const TL_UI_COLOR_TYPES: Set<
...
// @public (undocumented)
export const uiColorTypeValidator: T.Validator<
	'accent' | 'black' | 'laser' | 'muted-1' | 'selection-fill' | 'selection-stroke' | 'white'
>

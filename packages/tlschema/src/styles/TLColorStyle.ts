...
export const DefaultColorThemePalette: {
	...
	lightMode: {
		...
		brown: {
			solid: '#8B4513',
			fill: '#8B4513',
			frameHeadingStroke: '#A0522D',
			frameHeadingFill: '#fdfaf8',
			frameStroke: '#A0522D',
			frameFill: '#fdfaf8',
			frameText: '#000000',
			noteFill: '#DEB887',
			...
			semi: '#f5f0eb',
			pattern: '#A0522D',
			highlightSrgb: '#D2691E',
			highlightP3: 'color(display-p3 0.8235 0.4118 0.1176)',
		},
		pink: {
			solid: '#FF69B4',
			fill: '#FF69B4',
			frameHeadingStroke: '#FF1493',
			frameHeadingFill: '#fff0f8',
			frameStroke: '#FF1493',
			frameFill: '#fff0f8',
			frameText: '#000000',
			noteFill: '#FFB6C1',
			...
			highlightP3: 'color(display-p3 1 0.4118 0.7059)',
		},
		cyan: {
			solid: '#00CED1',
			fill: '#00CED1',
			frameHeadingStroke: '#20B2AA',
			frameHeadingFill: '#f0ffff',
			frameStroke: '#20B2AA',
			frameFill: '#f0ffff',
			frameText: '#000000',
			noteFill: '#87CEEB',
			...
			semi: '#e6ffff',
			pattern: '#20B2AA',
			highlightSrgb: '#00FFFF',
			highlightP3: 'color(display-p3 0 1 1)',
		},
	},
	darkMode: {
		id: 'dark',
		...
		brown: {
			solid: '#D2691E',
			fill: '#D2691E',
			frameHeadingStroke: '#8B4513',
			frameHeadingFill: '#2d1f13',
			frameStroke: '#8B4513',
			frameFill: '#1a1510',
			frameText: '#f2f2f2',
			noteFill: '#A0522D',
			...
			semi: '#3d2f25',
			pattern: '#8B4513',
			highlightSrgb: '#CD853F',
			highlightP3: 'color(display-p3 0.8039 0.5216 0.2471)',
		},
		pink: {
			solid: '#FF69B4',
			fill: '#FF69B4',
			frameHeadingStroke: '#C71585',
			frameHeadingFill: '#2d1a2d',
			frameStroke: '#C71585',
			frameFill: '#1a0f1a',
			frameText: '#f2f2f2',
			noteFill: '#DB7093',
			...
			semi: '#3d2a3d',
			pattern: '#C71585',
			highlightSrgb: '#FF1493',
			highlightP3: 'color(display-p3 1 0.0784 0.5765)',
		},
		cyan: {
			solid: '#00CED1',
			fill: '#00CED1',
			frameHeadingStroke: '#008B8B',
			frameHeadingFill: '#1a2d2d',
			frameStroke: '#008B8B',
			frameFill: '#0f1a1a',
			frameText: '#f2f2f2',
			noteFill: '#20B2AA',

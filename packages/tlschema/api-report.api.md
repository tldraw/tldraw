...
// @public
export type TLThemeColorPalette = Pick<TLThemeColors, TLThemeUiColorKeys> & Partial<Omit<TLThemeColors, TLThemeUiColorKeys>>;
...
// @public
export type TLThemeUiColorKeys = 'background' | 'cursor' | 'noteBorder' | 'solid' | 'text';

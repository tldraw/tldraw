...
export declare class Utils {
     ...
     *```
     */
    static lerpColor(color1: string, color2: string, factor?: number): string | undefined;
    /**
   ...
   */
     ...
     * Debounce a function.
     */
    static debounce<T extends (...args: unknown[]) => void>(fn: T, ms?: number): (...args: Parameters<T>) => void;
    /**

import { Bounds, Intersection } from '@tldraw/core'
import { Vec, Utils } from './index'

/* ----------------- Start Copy Here ---------------- */

function getIntersection(message: string, ...points: number[][]): Intersection {
...
export class Intersect {
  ...
  static ellipse = {
    ...
    ellipse(
      ...
      return getIntersection('intersection', ...result)
    },

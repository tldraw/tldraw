...
// @public (undocumented)
export const TldrawUiToolbar: ({ children, className, label }: TLUiToolbarProps) => JSX_2.Element;

// @public (undocumented)
export const TldrawUiToolbarButton: ({ asChild, children, type, isActive, ...props }: TLUiToolbarButtonProps) => JSX_2.Element;

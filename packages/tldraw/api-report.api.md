...
// @public
export function setMarkOnRichText(richText: TLRichText, markName: string, enabled: boolean, attrs?: Record<string, unknown>): TLRichText;
...
export interface TLUiEventMap {
    ...
    // (undocumented)
    'rich-text': {
        operation: 'bold' | 'bulletList' | 'heading' | 'italic' | 'link-edit' | 'link-remove' | 'link-visit' | 'link' | 'strike' | 'underline';
    };
    // (undocumented)
    'rotate-ccw': {
        fine: boolean;

...
export interface TLUiEventMap {
    ...
    // (undocumented)
    'rich-text': {
        operation: 'bold' | 'bulletList' | 'heading' | 'link-edit' | 'link-remove' | 'link-visit' | 'link' | 'strike' | 'taskList';
    };
    // (undocumented)
    'rotate-ccw': {
        fine: boolean;

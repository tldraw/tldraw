...
// @public (undocumented)
export function DefaultStylePanelContent({ colorAreaHeight }?: DefaultStylePanelContentProps): JSX.Element;

// @public (undocumented)
export interface DefaultStylePanelContentProps {
    colorAreaHeight?: 'auto' | number;
}

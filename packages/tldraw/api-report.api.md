...
export class ImageShapeUtil extends BaseBoxShapeUtil<TLImageShape> {
    ...
    // (undocumented)
    getFontFaces(shape: TLImageShape): TLFontFace[];
    // (undocumented)
...
// @public
export const TldrawUiContextualToolbar: ({ children, className, isMousingDown, getSelectionBounds, forcePositionUpdateAtom, }: TLUiContextualToolbarProps) => JSX_2.Element;
...
export class VideoShapeUtil extends BaseBoxShapeUtil<TLVideoShape> {
    ...
    // (undocumented)
    getFontFaces(shape: TLVideoShape): TLFontFace[];
    // (undocumented)

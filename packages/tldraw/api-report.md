...
export interface TLUiEventMap {
    ...
    // (undocumented)
    'rich-text': {
        operation: 'bold' | 'bulletList' | 'heading' | 'link-edit' | 'link-remove' | 'link' | 'strike';
    };
    // (undocumented)
    'rotate-ccw': null;
    // (undocumented)

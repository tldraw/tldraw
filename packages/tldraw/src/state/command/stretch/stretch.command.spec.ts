...
describe('Stretch command', () => {
  ...
  it('does, undoes and redoes command', () => {
    ...
    expect(tlstate.getShape<RectangleShape>('rect1').size).toStrictEqual([
      200,
      100,
    ])
    expect(tlstate.getShape<RectangleShape>('rect2').point).toStrictEqual([
      0,
      100,
    ])
    expect(tlstate.getShape<RectangleShape>('rect2').size).toStrictEqual([
      200,
      100,
    ])

...
import { AllSidesIcon, ReaderIcon, VideoIcon } from '@radix-ui/react-icons'
...
type ShapeShape = TDShapeType.Content | TDShapeType.Video | TDShapeType.ViewZone

const shapeShapes: ShapeShape[] = [TDShapeType.Content, TDShapeType.Video, TDShapeType.ViewZone]

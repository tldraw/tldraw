...
import { cloudOutline, cloudSvgPath } from './cloud-helpers'
import { DashStyleCloud } from './components/DashStyleCloud'
import { DashStyleEllipse } from './components/DashStyleEllipse'
import { DashStyleOval } from './components/DashStyleOval'
import { DashStylePolygon } from './components/DashStylePolygon'
import { DrawStyleCloud } from './components/DrawStyleCloud'
import { getEllipseIndicatorPath } from './components/DrawStyleEllipse'
import { DrawStylePolygon } from './components/DrawStylePolygon'
import { SolidStyleCloud } from './components/SolidStyleCloud'
import { SolidStyleEllipse } from './components/SolidStyleEllipse'
import { SolidStyleOval, getOvalIndicatorPath } from './components/SolidStyleOval'
import { SolidStylePolygon } from './components/SolidStylePolygon'
import { getCloudSvg, getEllipseSvg, getOvalSvg, getPolygonSvg } from './geo-svgs'
...
export class GeoShapeUtil extends BaseBoxShapeUtil<TLGeoShape> {
	...
	override toSvg(shape: TLGeoShape, ctx: SvgExportContext) {
		...
		switch (shape.props.geo) {
			case 'ellipse': {
				shapeString = getEllipseSvg(shape, theme)
				break
			}
			case 'oval': {
				shapeString = getOvalSvg(shape, theme)
				break
			}
			case 'cloud': {
				shapeString = getCloudSvg(shape, theme)
				break
			}
			default: {
				shapeString = getPolygonSvg(this.editor, shape, theme)
				break
			}
		}
		...
		if (shape.props.text) {
			...
			const textElm = createTextSvgStringFromSpans(spans, {
				...opts,
				fill: theme[shape.props.labelColor].solid,
			})
			const textBgElm = createTextSvgStringFromSpans(spans, {
				...opts,

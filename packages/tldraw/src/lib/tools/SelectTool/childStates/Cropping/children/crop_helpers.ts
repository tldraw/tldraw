import { Editor, TLImageShape, TLShapePartial, Vec, deepCopy } from '@tldraw/editor'

export function getTranslateCroppedImageChange(editor: Editor, shape: TLImageShape, delta: Vec) {
	if (!shape) {

...
export const STYLES = {
	...
	fillExtra: [
		...
		{ value: 'lined-chevrons', icon: 'fill-lined-chevrons' },
		{ value: 'lined-crosses', icon: 'fill-lined-crosses' },
		{ value: 'lined-dots', icon: 'fill-lined-dots' },
		{ value: 'lined-sparse-dots', icon: 'fill-lined-sparse-dots' },
		{ value: 'large-check', icon: 'fill-large-check' },
		{ value: 'small-check', icon: 'fill-small-check' },
	],
	dash: [

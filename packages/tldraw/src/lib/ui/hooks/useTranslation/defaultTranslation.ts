...
export const DEFAULT_TRANSLATION = {
	...
	'action.toggle-embed-scene.context-menu': 'Embed scene',
	'action.toggle-embed-scene.menu': 'Embed scene',
	'action.toggle-embed-scene': 'Toggle embedding scene in image file',
	'action.undo': 'Undo',

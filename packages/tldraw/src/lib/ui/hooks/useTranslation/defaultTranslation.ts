...
export const DEFAULT_TRANSLATION = {
	...
	'comments.replies': '{count, plural, one {# reply} other {# replies}}',
	...
	'error.cancel': 'Cancel',
	'error.confirm-reset.description':
		'Resetting your data will delete your drawing and cannot be undone.',
	'error.confirm-reset.title': 'Are you sure?',
	'error.copied': 'Copied!',
	'error.copy': 'Copy',
	'error.hide-details': 'Hide details',
	'error.message-label': 'Message:',
	'error.note-label': 'Note:',
	'error.refresh-hint': 'Please refresh your browser.',
	'error.refresh-page': 'Refresh page',
	'error.reset-data': 'Reset data',
	'error.reset-hint':
		'If the issue continues after refreshing, you may need to reset the tldraw data stored on your device.',
	'error.reset-note': 'Resetting will erase your current project and any unsaved work.',
	'error.show-details': 'Show details',
	'error.stack-trace-label': 'Stack trace:',
	'error.title': 'Something went wrong',
	'comments.unknown-author': 'Someone',
	'embed-dialog.learn-more': 'Learn more',
}

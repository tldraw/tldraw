...
export const DEFAULT_TRANSLATION = {
	...
	'toast.unsupported-shapes.some.title': 'Some shapes couldn’t be pasted',
	'toast.unsupported-shapes.some.desc-one':
		'1 shape uses a type that isn’t supported here, so it was left out.',
	'toast.unsupported-shapes.some.desc-many':
		'{count} shapes use a type that isn’t supported here, so they were left out.',
	'toast.unsupported-shapes.none.title': 'No shapes could be pasted',
	'toast.unsupported-shapes.none.desc': 'This content uses shape types that aren’t supported here.',

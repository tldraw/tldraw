...
export const DEFAULT_TRANSLATION = {
	...
	'theme.light': 'Light',
	'theme.system': 'System',
	'action.open-command-bar': 'Open command bar',
	...
	'action.toggle-auto-size-disabled-description': 'You need to have a text shape selected',
	...
	'action.download-original-disabled-description': 'You need to have an image or video selected',

...
export type TLUiTranslationKey =
	...
	| 'color-style.violet'
	| 'color-style.yellow'
	| 'color-style.custom-1'
	| 'color-style.custom-2'
	| 'color-style.custom-3'
	| 'color-style.custom-4'
	| 'color-style.custom-5'
	| 'color-style.custom-6'
	| 'color-style.custom-7'
	| 'color-style.custom-8'
	| 'color-style.custom-9'
	| 'color-style.custom-10'
	| 'color-style.custom-11'
	| 'color-style.custom-12'
	| 'fill-style.none'

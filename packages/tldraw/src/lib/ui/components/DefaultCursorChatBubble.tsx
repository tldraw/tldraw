...
// todo:
// - not cleaning up
const CHAT_MESSAGE_TIMEOUT_CLOSING = 200000
const CHAT_MESSAGE_TIMEOUT_CHATTING = 500000

/** @public @react */
export const DefaultCursorChatBubble = track(function CursorChatBubble() {
	const editor = useEditor()
	const { isChatting, chatMessage } = editor.getInstanceState()
	console.log({ isChatting, chatMessage })

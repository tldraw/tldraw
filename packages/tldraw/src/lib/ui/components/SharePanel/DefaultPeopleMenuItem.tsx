import { createUserId, TLUserId, track, useEditor, usePresence } from '@tldraw/editor'
...
export const DefaultPeopleMenuItem = track(function DefaultPeopleMenuItem({
	...
	const theyAreFollowingYou = presence?.followingUserId === createUserId(editor.user.getId())

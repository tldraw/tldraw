...
import {
	MermaidSequenceLoopFixture,
	mermaidSequenceLoopFixtures,
} from './fixtures/mermaidSequenceLoopFixtures'
import { TestEditor } from './TestEditor'

const isStrictLoopMode = process.env.TLDRAW_MERMAID_LOOP_STRICT === '1'

describe('mermaid sequence loop fixtures', () => {
	for (const fixture of mermaidSequenceLoopFixtures) {
...
async function importFixture(fixture: MermaidSequenceLoopFixture) {

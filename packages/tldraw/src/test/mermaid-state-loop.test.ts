...
import {
	MermaidStateLoopFixture,
	mermaidStateLoopFixtures,
} from './fixtures/mermaidStateLoopFixtures'
import { TestEditor } from './TestEditor'

const isStrictLoopMode = process.env.TLDRAW_MERMAID_LOOP_STRICT === '1'

describe('mermaid state loop fixtures', () => {
	for (const fixture of mermaidStateLoopFixtures) {
...
async function importFixture(fixture: MermaidStateLoopFixture) {

...
import { MermaidERLoopFixture, mermaidERLoopFixtures } from './fixtures/mermaidERLoopFixtures'
import { TestEditor } from './TestEditor'

const isStrictLoopMode = process.env.TLDRAW_MERMAID_LOOP_STRICT === '1'

describe('mermaid er loop fixtures', () => {
	for (const fixture of mermaidERLoopFixtures) {
...
async function importFixture(fixture: MermaidERLoopFixture) {

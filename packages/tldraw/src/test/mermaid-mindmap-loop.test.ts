...
import {
	MermaidMindmapLoopFixture,
	mermaidMindmapLoopFixtures,
} from './fixtures/mermaidMindmapLoopFixtures'
import { TestEditor } from './TestEditor'

const isStrictLoopMode = process.env.TLDRAW_MERMAID_LOOP_STRICT === '1'

describe('mermaid mindmap loop fixtures', () => {
	for (const fixture of mermaidMindmapLoopFixtures) {
...
async function importFixture(fixture: MermaidMindmapLoopFixture) {

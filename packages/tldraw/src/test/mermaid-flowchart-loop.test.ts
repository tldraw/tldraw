...
import {
	MermaidFlowchartLoopFixture,
	mermaidFlowchartLoopFixtures,
} from './fixtures/mermaidFlowchartLoopFixtures'
import { TestEditor } from './TestEditor'

const isStrictLoopMode = process.env.TLDRAW_MERMAID_LOOP_STRICT === '1'

describe('mermaid flowchart loop fixtures', () => {
	for (const fixture of mermaidFlowchartLoopFixtures) {
...
async function importFixture(fixture: MermaidFlowchartLoopFixture) {

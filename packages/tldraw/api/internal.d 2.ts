...
/** @internal */
export declare function kickoutOccludedShapes(editor: Editor, shapeIds: TLShapeId[]): void;
...
/** @internal */
export declare function parseAndLoadDocument(editor: Editor, document: string, msg: (id: Exclude<string, TLUiTranslationKey> | TLUiTranslationKey) => string, addToast: TLUiToastsContextType['addToast'], onV1FileLoad?: () => void, forceDarkMode?: boolean): Promise<void>;
...
/** @internal */
export declare function Spinner(props: React_3.SVGProps<SVGSVGElement>): JSX_2.Element;
 ...
 * @internal
 */
export declare function TldrawUiTranslationProvider({ overrides, locale, children, }: TLUiTranslationProviderProps): JSX_2.Element;
...
/** @internal */
export declare enum TLV1AlignStyle {
    Start = "start",
    Middle = "middle",
    End = "end",
    Justify = "justify"
...
/** @internal */
export declare interface TLV1ArrowBinding extends TLV1BaseBinding {
...
/** @internal */
export declare interface TLV1ArrowShape extends TLV1BaseShape {
...
/** @internal */
export declare type TLV1Asset = TLV1ImageAsset | TLV1VideoAsset;

/** @internal */
export declare enum TLV1AssetType {
    Image = "image",
    Video = "video"
}

/** @internal */
export declare interface TLV1BaseAsset {
    id: string;
    type: string;
}

/** @internal */
export declare interface TLV1BaseBinding {
    id: string;
    toId: string;
    fromId: string;
}
...
/** @internal */
export declare interface TLV1BaseShape {
    id: string;
    parentId: string;
    childIndex: number;
    name: string;
...
/** @internal */
export declare type TLV1Binding = TLV1ArrowBinding;

/** @internal */
export declare interface TLV1Bounds {
    minX: number;
    minY: number;
    maxX: number;
    maxY: number;
...
/** @internal */
export declare enum TLV1ColorStyle {
    White = "white",
    LightGray = "lightGray",
    Gray = "gray",
    Black = "black",
...
/** @internal */
export declare enum TLV1DashStyle {
    Draw = "draw",
    Solid = "solid",
    Dashed = "dashed",
    Dotted = "dotted"
...
/** @internal */
export declare enum TLV1Decoration {
    Arrow = "arrow"
}

/** @internal */
export declare interface TLV1Document {
    id: string;
    name: string;
    version: number;
...
/** @internal */
export declare interface TLV1DrawShape extends TLV1BaseShape {
...
/** @internal */
export declare interface TLV1EllipseShape extends TLV1BaseShape {
...
/** @internal */
export declare enum TLV1FontStyle {
    Script = "script",
    Sans = "sans",
    Serif = "serif",
    Mono = "mono"
...
/** @internal */
export declare interface TLV1GroupShape extends TLV1BaseShape {
...
/** @internal */
export declare interface TLV1Handle {
    id: string;
    index: number;
    point: number[];
    canBind?: boolean;
...
/** @internal */
export declare interface TLV1ImageAsset extends TLV1BaseAsset {
...
/** @internal */
export declare interface TLV1ImageShape extends TLV1BaseShape {
...
/** @internal */
export declare interface TLV1Page {
    id: string;
    name?: string;
    childIndex?: number;
...
/** @internal */
export declare interface TLV1PageState {
    id: string;
    selectedIds: string[];
    camera: {
        point: number[];
...
/** @internal */
export declare interface TLV1RectangleShape extends TLV1BaseShape {
...
/** @internal */
export declare type TLV1Shape = TLV1ArrowShape | TLV1DrawShape | TLV1EllipseShape | TLV1GroupShape | TLV1ImageShape | TLV1RectangleShape | TLV1StickyShape | TLV1TextShape | TLV1TriangleShape | TLV1VideoShape;

/** @internal */
export declare interface TLV1ShapeStyles {
...
/** @internal */
export declare enum TLV1ShapeType {
    Sticky = "sticky",
    Ellipse = "ellipse",
    Rectangle = "rectangle",
    Triangle = "triangle",
...
/** @internal */
export declare enum TLV1SizeStyle {
    Small = "small",
    Medium = "medium",
    Large = "large"
}
...
/** @internal */
export declare interface TLV1StickyShape extends TLV1BaseShape {
...
/** @internal */
export declare interface TLV1TextShape extends TLV1BaseShape {
    type: TLV1ShapeType.Text;
    text: string;
}

/** @internal */
export declare interface TLV1TriangleShape extends TLV1BaseShape {
...
/** @internal */
export declare interface TLV1VideoAsset extends TLV1BaseAsset {
...
/** @internal */
export declare interface TLV1VideoShape extends TLV1BaseShape {

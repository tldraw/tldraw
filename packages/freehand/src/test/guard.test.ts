...
// order them differently). Normalizing the specifiers and sorting the import
// lines lets us compare everything else byte-for-byte, so the vendored
// primitives can't silently drift from the editor's.

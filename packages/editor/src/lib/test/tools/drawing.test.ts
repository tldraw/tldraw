...
import { TLDrawShape } from '../../schema/shapes/TLDrawShape'
...
for (const toolType of ['draw', 'highlight'] as const) {
	describe(`When ${toolType}ing...`, () => {
		...
		it('Extends previously drawn line when shift is held', () => {
			...
			const shape1 = editor.shapesArray[0] as DrawableShape
			...
			const shape2 = editor.shapesArray[0] as DrawableShape
		...
		it('Does not extends previously drawn line after switching to another tool', () => {
			...
			const shape2 = editor.shapesArray[1] as DrawableShape

...
export { getStroke } from './lib/primitives/freehand/getStroke'
export { getStrokeOutlinePoints } from './lib/primitives/freehand/getStrokeOutlinePoints'
export { getStrokePoints } from './lib/primitives/freehand/getStrokePoints'
export { setStrokePointRadii } from './lib/primitives/freehand/setStrokePointRadii'
export { getSvgPathFromStrokePoints } from './lib/primitives/freehand/svg'
export { svgInk } from './lib/primitives/freehand/svgInk'
export { type StrokeOptions, type StrokePoint } from './lib/primitives/freehand/types'

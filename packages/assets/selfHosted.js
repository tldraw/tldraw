...
export function getAssetUrls(opts) {
	...
	return {
		...
		translations: {
			...
			gu_IN: formatAssetUrl('./translations/gu_IN.json', opts),
			he: formatAssetUrl('./translations/he.json', opts),
			'hi-in': formatAssetUrl('./translations/hi-in.json', opts),
			hi_IN: formatAssetUrl('./translations/hi_IN.json', opts),
			...
			km_KH: formatAssetUrl('./translations/km_KH.json', opts),
			kn: formatAssetUrl('./translations/kn.json', opts),
			'ko-kr': formatAssetUrl('./translations/ko-kr.json', opts),
			ko_KR: formatAssetUrl('./translations/ko_KR.json', opts),
			...
			pt_BR: formatAssetUrl('./translations/pt_BR.json', opts),
			pt_PT: formatAssetUrl('./translations/pt_PT.json', opts),
			...
			zh_CN: formatAssetUrl('./translations/zh_CN.json', opts),
			zh_TW: formatAssetUrl('./translations/zh_TW.json', opts),
		},
		embedIcons: {

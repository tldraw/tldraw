...
export function getAssetUrls(opts) {
	...
	return {
		...
		icons: {
			...
			'fill-chevrons': iconsIcon0MergedSvg + '#fill-chevrons',
			'fill-crosses': iconsIcon0MergedSvg + '#fill-crosses',
			'fill-dense-dots': iconsIcon0MergedSvg + '#fill-dense-dots',
			'fill-dots': iconsIcon0MergedSvg + '#fill-dots',
			'fill-fill': iconsIcon0MergedSvg + '#fill-fill',
			'fill-large-check': iconsIcon0MergedSvg + '#fill-large-check',
			'fill-lined-chevrons': iconsIcon0MergedSvg + '#fill-lined-chevrons',
			'fill-lined-crosses': iconsIcon0MergedSvg + '#fill-lined-crosses',
			'fill-lined-dense-dots': iconsIcon0MergedSvg + '#fill-lined-dense-dots',
			'fill-lined-dots': iconsIcon0MergedSvg + '#fill-lined-dots',
			'fill-lined-fill': iconsIcon0MergedSvg + '#fill-lined-fill',
			'fill-lined-pattern': iconsIcon0MergedSvg + '#fill-lined-pattern',
			'fill-lined-sparse-dots': iconsIcon0MergedSvg + '#fill-lined-sparse-dots',
			...
			'fill-small-check': iconsIcon0MergedSvg + '#fill-small-check',
			'fill-solid': iconsIcon0MergedSvg + '#fill-solid',
			'fill-sparse-dots': iconsIcon0MergedSvg + '#fill-sparse-dots',

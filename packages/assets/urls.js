...
export function getAssetUrlsByMetaUrl(opts) {
	return {
		...
		icons: {
			...
			'logo-1': formatAssetUrl(new URL('./icons/icon/logo-1.svg', import.meta.url).href, opts),
			'logo-2': formatAssetUrl(new URL('./icons/icon/logo-2.svg', import.meta.url).href, opts),
			'logo-3': formatAssetUrl(new URL('./icons/icon/logo-3.svg', import.meta.url).href, opts),

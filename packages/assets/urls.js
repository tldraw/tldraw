...
export function getAssetUrlsByMetaUrl(opts) {
	...
	return {
		...
		icons: {
			...
			'speaker-loud': iconsIcon0MergedSvg + '#speaker-loud',
			'speaker-moderate': iconsIcon0MergedSvg + '#speaker-moderate',
			'speaker-off': iconsIcon0MergedSvg + '#speaker-off',
			'speaker-quiet': iconsIcon0MergedSvg + '#speaker-quiet',

...
export function getAssetUrlsByImport(opts) {
	...
	return {
		...
		icons: {
			...
			'fill-chevrons': iconsIcon0MergedSvg2 + '#fill-chevrons',
			'fill-crosses': iconsIcon0MergedSvg2 + '#fill-crosses',
			'fill-dense-dots': iconsIcon0MergedSvg2 + '#fill-dense-dots',
			'fill-dots': iconsIcon0MergedSvg2 + '#fill-dots',
			'fill-fill': iconsIcon0MergedSvg2 + '#fill-fill',
			'fill-large-check': iconsIcon0MergedSvg2 + '#fill-large-check',
			'fill-lined-chevrons': iconsIcon0MergedSvg2 + '#fill-lined-chevrons',
			'fill-lined-crosses': iconsIcon0MergedSvg2 + '#fill-lined-crosses',
			'fill-lined-dense-dots': iconsIcon0MergedSvg2 + '#fill-lined-dense-dots',
			'fill-lined-dots': iconsIcon0MergedSvg2 + '#fill-lined-dots',
			'fill-lined-fill': iconsIcon0MergedSvg2 + '#fill-lined-fill',
			'fill-lined-pattern': iconsIcon0MergedSvg2 + '#fill-lined-pattern',
			'fill-lined-sparse-dots': iconsIcon0MergedSvg2 + '#fill-lined-sparse-dots',
			...
			'fill-small-check': iconsIcon0MergedSvg2 + '#fill-small-check',
			'fill-solid': iconsIcon0MergedSvg2 + '#fill-solid',
			'fill-sparse-dots': iconsIcon0MergedSvg2 + '#fill-sparse-dots',

...
export function getAssetUrlsByImport(opts) {
	...
	return {
		fonts: {
			tldraw_mono_normal_bold: formatAssetUrl(fontsIBMPlexMonoBoldWoff2, opts),
			tldraw_mono_italic_bold: formatAssetUrl(fontsIBMPlexMonoBoldItalicWoff2, opts),
			tldraw_mono_normal_normal: formatAssetUrl(fontsIBMPlexMonoMediumWoff2, opts),
			tldraw_mono_italic_normal: formatAssetUrl(fontsIBMPlexMonoMediumItalicWoff2, opts),
			tldraw_sans_normal_bold: formatAssetUrl(fontsIBMPlexSansBoldWoff2, opts),
			tldraw_sans_italic_bold: formatAssetUrl(fontsIBMPlexSansBoldItalicWoff2, opts),
			tldraw_sans_normal_normal: formatAssetUrl(fontsIBMPlexSansMediumWoff2, opts),
			tldraw_sans_italic_normal: formatAssetUrl(fontsIBMPlexSansMediumItalicWoff2, opts),
			tldraw_serif_normal_bold: formatAssetUrl(fontsIBMPlexSerifBoldWoff2, opts),
			tldraw_serif_italic_bold: formatAssetUrl(fontsIBMPlexSerifBoldItalicWoff2, opts),
			tldraw_serif_normal_normal: formatAssetUrl(fontsIBMPlexSerifMediumWoff2, opts),
			tldraw_serif_italic_normal: formatAssetUrl(fontsIBMPlexSerifMediumItalicWoff2, opts),
			tldraw_draw_normal_bold: formatAssetUrl(fontsShantellSansInformalBoldWoff2, opts),
			tldraw_draw_italic_bold: formatAssetUrl(fontsShantellSansInformalBoldItalicWoff2, opts),
			tldraw_draw_normal_normal: formatAssetUrl(fontsShantellSansInformalRegularWoff2, opts),
			tldraw_draw_italic_normal: formatAssetUrl(fontsShantellSansInformalRegularItalicWoff2, opts),
		},
		icons: {

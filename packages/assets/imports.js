...
export function getAssetUrlsByImport(opts) {
	...
	return {
		...
		icons: {
			...
			'speaker-loud': iconsIcon0MergedSvg2 + '#speaker-loud',
			'speaker-moderate': iconsIcon0MergedSvg2 + '#speaker-moderate',
			'speaker-off': iconsIcon0MergedSvg2 + '#speaker-off',
			'speaker-quiet': iconsIcon0MergedSvg2 + '#speaker-quiet',

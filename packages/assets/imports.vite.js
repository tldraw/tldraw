...
import embedIconsDatadogPngUrl from './embed-icons/datadog.png?url'
...
import embedIconsHoppscotchPngUrl from './embed-icons/hoppscotch.png?url'
...
export function getAssetUrlsByImport(opts) {
	...
	return {
		...
		embedIcons: {
			...
			datadog: formatAssetUrl(embedIconsDatadogPngUrl, opts),
			...
			hoppscotch: formatAssetUrl(embedIconsHoppscotchPngUrl, opts),

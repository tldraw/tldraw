...
The branching chat starter kit builds on tldraw's extensible architecture with 4 core systems working together:
...
**Custom Shape Development**: Learn how to create advanced custom shapes with complex interactions and state management in tldraw applications.

**AI Integration Patterns**: Learn more about streaming AI responses and managing conversation context in React applications with the Vercel AI SDK.

**Cloudflare Workers Deployment**: Learn how to deploy full-stack tldraw applications using Cloudflare Workers and Durable Objects for global performance.

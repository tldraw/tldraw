...
date: 10/14/2024
order: 7
description: The Shader Starter Kit demonstrates how to integrate WebGL shaders with [tldraw](https://github.com/tldraw/tldraw), creating dynamic backgrounds that respond to canvas interactions. It includes four complete examples and a reusable `WebGLManager` base class for building custom shader effects.
embed: shader
...
completeness: 8
accuracy: 8
notes: "'Use Cases' should be sentence case. Well-structured for technical topic. Good external resource links and GitHub references."
---

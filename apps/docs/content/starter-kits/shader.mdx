...
- **[WebGLManager](https://github.com/tldraw/tldraw/tree/main/templates/shader/src/WebGLManager.ts) base class** ([`src/WebGLManager.ts`](https://github.com/tldraw/tldraw/tree/main/templates/shader/src/WebGLManager.ts)) - Handles WebGL lifecycle, viewport synchronization, and animation loop integration with tldraw's reactive system

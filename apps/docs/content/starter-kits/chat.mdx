...
date: 9/16/2024
order: 3
description: The Chat Starter Kit shows how to integrate tldraw's infinite canvas into an existing chat application. Built on [Vercel's useChat hook](https://ai-sdk.dev/docs/reference/ai-sdk-ui/use-chat), this template shows you how to add visual annotation capabilities to any app (in this case, a chat).
embed: chat
githubLink: https://github.com/tldraw/tldraw/tree/main/templates/chat
keywords:
  - chat
  - messaging
  - collaboration
...
completeness: 7
accuracy: 8
notes: "'Use Cases' should be sentence case. Good concise coverage. Line number references are helpful. Could use a code example."
---

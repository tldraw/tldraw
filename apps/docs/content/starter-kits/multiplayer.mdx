...
<Embed
	src="https://multiplayer-template.tldraw.workers.dev/?utm_source=docs-embed"
	tryButton="Try starter kit"
/>

The Multiplayer Starter Kit demonstrates how to build self-hosted tldraw applications with real-time multiplayer collaboration using Cloudflare Durable Objects. It features production-ready backend infrastructure that handles WebSocket connections, automatic persistence, and asset management. You can use this foundation to create collaborative whiteboards, design tools, or any multi-user canvas application. [See Demo](https://tldraw-sync-cloudflare.tldraw.workers.dev/)

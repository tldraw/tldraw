...
Starter kits provide implementations of common canvas-based use cases, including frontend components and starting points for backend infrastructure and deployment configuration. Use them to prototype ideas or as the foundation for new projects. The source code is yours to hack on.

...
This last step—annotating the screenshot—is a key part of the process. Jam users loved the ability to scribble on screenshots but the team knew they could make the tool better. They decided it was time for an upgrade.

...
This last step—annotating the screenshot—is a key part of the process. Developers loved the ability to scribble on screenshots but the Jam team knew they could do better. They decided it was time for an upgrade.

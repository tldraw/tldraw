...
The name "computer" stuck internally, so despite our efforts to come up with other names, we settled on the one we were always using. And that's how tldraw computer avoided being called "Slop", "Goo", "Juice", "Pump" or "Blurp".

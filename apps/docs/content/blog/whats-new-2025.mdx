...
We rewrote our arrangement features to better handle shapes that are connected by arrows. These changes effect alignment, flipping, distribution, stretching, packing and stacking actions.

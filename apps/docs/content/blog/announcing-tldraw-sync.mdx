...
hero: https://substackcdn.com/image/fetch/w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F153968e1-91ef-4dfe-a66c-b13cd23b2a67_1920x1080.gif
date: 08/05/2024
status: published
author: steveruizok
---
...
Let’s use the tldraw sync demo server in a React app. Feel like watching a video instead? [Click here](https://www.youtube.com/watch?v=COw7Wm9HS-g). Want to try it live? Check out the [CodeSandbox example](https://codesandbox.io/p/sandbox/tldraw-sync-demo-d9vq5g)!
...
If you’re running your code locally, you can open an incognito window to test. If your project is online (such as with our [CodeSandbox example](https://codesandbox.io/p/sandbox/tldraw-sync-demo-d9vq5g)), you can send the URL to a friend to collaborate instantly.
...
[![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdc6f2223-5571-4942-ba08-460ef89d2a1d_962x542.gif)](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdc6f2223-5571-4942-ba08-460ef89d2a1d_962x542.gif)
...
tldraw sync is covered by the tldraw SDK’s existing license. If you are using the tldraw SDK in a non-commercial context, such as a personal project or in education, then you are free to use tldraw sync alongside the rest of the SDK. If you have purchased a commercial license, then you can begin using tldraw sync under your existing license at no additional charge.
...
[Give tldraw sync a try](https://tldraw.dev/docs/sync) and let us know what you think. If you’d like to learn more, connect with tldraw [on Discord](https://discord.com/invite/SBBEVCA4PG), follow us on [X](https://twitter.com/tldraw), or reach out at [hello@tldraw.com](mailto:hello@tldraw.com).

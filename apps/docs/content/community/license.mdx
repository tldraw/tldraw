...
### What license keys control

License keys encode several pieces of information:

- **Validity period** - Expiration date for the license.
- **Feature access** - Watermark display and functionality limits.
...
- **Production environment**: Servers, cloud platforms, web applications, or network-accessible deployments.

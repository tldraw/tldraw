...
- **Default license** - No license key needed.
- **Trial license** - Fill out a [Trial License form](/get-a-license/trial) and we will email you a license key.
- **Commercial license** - Speak with our [sales team](/get-a-license/plans) to determine your product needs.
- **Hobby license** - Fill out a [Hobby License form](/get-a-license/hobby) and we will get in touch.
...
- You cannot disable, hide, remove, or alter the watermark under Default license.
...
- You cannot distribute the SDK as a standalone product.
- You cannot sublicense, rent, lease, or transfer license rights.
- Must preserve all copyright and proprietary notices.

### Trial Restrictions

- Business Units are limited to one Trial License period unless otherwise approved by tldraw in writing.
- The Trial License Key is requested in a self-service portal [LINK] and automatically expires after one hundred (100) days from day of issuance, at which point the Software will cease to function unless an active license key is implemented.

### Offline usage

No license requires network connectivity
...
- [**Trademark policy**](https://github.com/tldraw/tldraw/blob/main/TRADEMARKS.md) - Additional trademark usage guidelines.

...
We don't collect any PII. To be completely transparent, we collect two pieces of information: the domain where tldraw is being hosted, and the country where the request came from.

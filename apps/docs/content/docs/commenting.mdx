...
```tsx
import { CanvasComments, commentTools, commentToolOverrides } from '@tldraw/commenting'
import { useMemo } from 'react'
import { commentSchemaRecords, createTLSchema, createTLStore, Tldraw } from 'tldraw'
import '@tldraw/commenting/commenting.css'
import 'tldraw/tldraw.css'

const AUTHORS = { me: { name: 'You', color: '#EC5E41' } }

const components = {
	InFrontOfTheCanvas: () => (
		<CanvasComments currentUserId="me" resolveAuthor={(id) => AUTHORS[id]} />
	),
}

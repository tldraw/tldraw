...
The sync demo is perfect for demos but should not be used in production.

- we delete all data after 24 hours
- anyone using the same room id will be able to edit the same file

If you want to use tldraw sync in production, see the next section for information on self-hosting the tldraw sync server.

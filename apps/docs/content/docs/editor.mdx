...
This page gives a broad idea of how the `Editor` class is organized and some of the architectural concepts involved. The full reference is available [here](/gen/editor/Editor-class).

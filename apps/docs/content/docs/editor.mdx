...
relationship. For example, an arrow binding always goes _from_ an arrow _to_ the shape it's bound
to.
...
[`BindingUtil`](/reference/editor/BindingUtil) classes to define how bindings should work.

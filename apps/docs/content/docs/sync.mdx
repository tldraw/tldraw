...
To use our sync engine in production, you need to host it yourself. There are three parts to sync in
tldraw:
...
- @tldraw/sync isn't the only way to do multiplayer in tldraw. maybe still point at yjs/simple sync example?

- fold collaboration.mdx into this page

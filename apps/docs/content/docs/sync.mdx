...
tldraw sync is a production-ready library for low-latency sync and collaboration, used to power multiplayer whiteboards in our flagship app at tldraw.com.
...
[tldraw-yjs example](https://github.com/tldraw/tldraw-yjs-example) illustrates a way of using the [yjs](https://yjs.dev) library with the tldraw SDK. Yjs is a CRDT and can resolve conflicts.

...
completeness: 7
accuracy: 8
notes: 'Some passive voice constructions. Good technical accuracy on APIs and internal class names. Missing API link format [Method](?) for cross-references. Example links are valid. Could mention toImageDataUrl method.'
---
...
- `preserveAspectRatio` sets the SVG `preserveAspectRatio` attribute. Only applies to SVG exports.

...
completeness: 9
accuracy: 8
notes: "Strong reference doc with comprehensive tables. Some AI tells (formulaic structure, bolded lists). First code example lacks imports. Configuration options well documented."
---

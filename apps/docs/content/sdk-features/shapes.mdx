...
completeness: 8
accuracy: 8
notes: 'APIs verified correct: getGeometry, hitTestPoint on Geometry2d, onResize return type, getFocusedGroup/setFocusedGroup/popFocusedGroupId. Opening paragraph is slightly dense.'
---

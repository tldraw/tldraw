...
- **[Rich text](https://github.com/tldraw/tldraw/tree/main/apps/examples/src/examples/rich-text)** - Work with text content that uses the text measurement system for layout.
- **[Custom fonts](https://github.com/tldraw/tldraw/tree/main/apps/examples/src/examples/custom-fonts)** - Load and use custom fonts with FontManager integration.

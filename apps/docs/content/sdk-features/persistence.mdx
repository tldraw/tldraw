...
status: published
date: 12/29/2025
notes: Excellent progressive disclosure and voice. Verify example links. Could mention synced-remote connectionStatus and snapshot prop with persistenceKey.
---

...
completeness: 7
accuracy: 8
notes: "Good structure and flow. Fixed usePrefersReducedMotion description and debugFlags import. Could add links to examples and expand keyboard nav."
---
...
- The `animationSpeed` preference is 0 (this is the default when the OS prefers reduced motion)

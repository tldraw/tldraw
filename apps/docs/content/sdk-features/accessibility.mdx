...
completeness: 8
accuracy: 9
notes: 'Improved code examples with full imports, fixed API references, clarified reduced motion behavior, added cross-references.'
---
...
Custom shapes can opt out of keyboard navigation by overriding [ShapeUtil#canTabTo](?):

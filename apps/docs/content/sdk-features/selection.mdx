...
completeness: 8
accuracy: 8
notes: "Well-structured doc covering selection API comprehensively. All API names verified correct. Code snippets accurate. Fixed: removed reference to private method `_getUnlockedShapeIds`. Opening could be punchier. Could mention `getSelectedShapeAtPoint` for completeness."
---

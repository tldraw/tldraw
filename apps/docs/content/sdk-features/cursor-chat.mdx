...
Remote users' chat messages render as part of the collaborator cursor overlay. To customize how they appear, replace [CollaboratorCursorOverlayUtil](?) — see [Cursors](/sdk-features/cursors#rendering-collaborator-cursors) for details.

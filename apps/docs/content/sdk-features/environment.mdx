...
completeness: 7
accuracy: 8
notes: "Strong organization and clear prose. Fixed: removed isWebview (never set in source), added missing imports for react() and useValue examples. Browser quirks section adds valuable context."
---
...
- **[Custom UI](https://github.com/tldraw/tldraw/tree/main/apps/examples/src/examples/custom-ui)** - Build custom interfaces that may need platform-specific behavior using tlenv for detection.

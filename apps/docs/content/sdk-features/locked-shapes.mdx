...
completeness: 9
accuracy: 10
notes: 'Well-structured with API links throughout. Code snippets are correct and use valid APIs. Table format for behaviors improves scanability. Keyboard shortcut verified. Links to shapes doc and ShapeUtil reference included.'
---
...
[ShapeUtils](/docs/shapes#shapeutils) can override [ShapeUtil#canEditWhileLocked](?) to allow editing interactions on locked shapes:

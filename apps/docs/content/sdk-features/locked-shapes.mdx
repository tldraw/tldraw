...
completeness: 7
accuracy: 10
notes: "Good structure and accurate API coverage. Code snippets are correct. Missing links to API docs and examples. Voice is mostly compliant but could be more concise in places."
---
...
When you lock shapes that were all previously unlocked, they automatically deselect. This prevents accidentally manipulating them while they're in the "protected" state.

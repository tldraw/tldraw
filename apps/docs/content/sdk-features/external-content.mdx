...
completeness: 9
accuracy: 9
notes: 'Complete documentation of all content types including file-replace. Full working example at top. Type interfaces and default handler exports listed. Tables for quick reference.'
---
...
- [External content sources](/examples/external-content/external-content-sources) - Handle pasted HTML by creating custom shapes.
- [Hosted images](/examples/assets/hosted-images) - Upload images to your own server using a custom asset store.

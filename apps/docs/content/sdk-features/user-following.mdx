...
Begins following a user's viewport. The method accepts a user ID and sets up frame handlers to track the user's camera and page.
...
- **[User presence](https://github.com/tldraw/tldraw/tree/main/apps/examples/src/examples/user-presence)** - Display collaborator cursors and presence information.
- **[Multiplayer/sync](https://github.com/tldraw/tldraw/tree/main/apps/examples/src/examples/sync-demo)** - Set up multiplayer sync which enables user following functionality.

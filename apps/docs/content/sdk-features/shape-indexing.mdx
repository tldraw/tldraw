...
completeness: 7
accuracy: 6
notes: "Good progressive structure and clear explanations. Code examples need IndexKey type casting. Example link to api-example is incorrect (should be api). Consider adding visual diagram."
---
...
```typescript
import { getIndexBetween, getIndicesAbove, getIndicesBelow, IndexKey } from '@tldraw/utils'

const index = getIndexBetween('a0' as IndexKey, 'a2' as IndexKey) // 'a1'
const indices = getIndicesAbove('a0' as IndexKey, 3) // ['a1', 'a2', 'a3']
const below = getIndicesBelow('a2' as IndexKey, 2) // ['a1', 'a0V']
```
...
- **[API example](https://github.com/tldraw/tldraw/tree/main/apps/examples/src/examples/api)** - Create shapes programmatically, including managing their z-order indices.

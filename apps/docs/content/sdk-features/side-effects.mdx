...
completeness: 8
accuracy: 9
notes: 'Well-structured with clear examples. Uses public APIs correctly. Code snippets match actual implementation. Could add beforeCreate example.'
---
...
After handlers are useful for maintaining referential integrity. When a shape is deleted, you can clean up related bindings:

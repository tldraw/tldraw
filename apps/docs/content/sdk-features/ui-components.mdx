...
The **TopPanel** is an empty slot available for custom content. It renders nothing by default. Use it to place your own UI in the top-center area of the editor.

...
The label is rendered by the `NoteShapeAttribution` component, which you can override or hide through the `components` prop. This applies on the canvas and in image exports:
...
;<Tldraw
	components={{
		NoteShapeAttribution: ({ firstName, color }) => (

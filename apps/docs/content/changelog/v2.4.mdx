...
For the first time, we're releasing our real-time collaboration engine—the one we developed for tldraw.com—as a general library. The SDK still supports any backend for collaboration, but we hope this will be the easiest option for developers. See the new `sync` package in the repository and the multiplayer-demo example. ([#4031](https://github.com/tldraw/tldraw/pull/4031))
...
([#4162](https://github.com/tldraw/tldraw/pull/4162))
...
([#4042](https://github.com/tldraw/tldraw/pull/4042))
...
- Custom tools can now decide whether they are affected by shape lock ([#4208](https://github.com/tldraw/tldraw/pull/4208))
- Icons are now served as a single SVG instead of many individual requests ([#4150](https://github.com/tldraw/tldraw/pull/4150))
...
- Use the new `ShapeIndicators` component to add custom logic about when to display indicators ([#4083](https://github.com/tldraw/tldraw/pull/4083))
- Shape opacity now animates ([#4242](https://github.com/tldraw/tldraw/pull/4242))
...
- Export `DefaultMenuPanel` ([#4193](https://github.com/tldraw/tldraw/pull/4193))
- The `fileSize` property of `TLImageAsset` and `TLVideoAsset` is now optional ([#4206](https://github.com/tldraw/tldraw/pull/4206))
- Pass a partial `TLEditorSnapshot` to `TldrawImage` and `useTLStore` ([#4190](https://github.com/tldraw/tldraw/pull/4190))
...
- Changing `cameraOptions` via React no longer causes editor to re-mount ([#4089](https://github.com/tldraw/tldraw/pull/4089))
- Allow high-res images to be uploaded ([#4198](https://github.com/tldraw/tldraw/pull/4198))
- Locked shapes can no longer be updated, grouped, or ungrouped programmatically ([#4042](https://github.com/tldraw/tldraw/pull/4042))
...
Fixed an issue where the `assets` prop on the `<Tldraw />` and `<TldrawEditor />` components was not being respected. ([#4285](https://github.com/tldraw/tldraw/pull/4285))

[View release on GitHub](https://github.com/tldraw/tldraw/releases/tag/v2.4.1)

### v2.4.2

Bug fixes and improvements for the sync engine and related packages. ([#4309](https://github.com/tldraw/tldraw/pull/4309))

[View release on GitHub](https://github.com/tldraw/tldraw/releases/tag/v2.4.2)

### v2.4.3

Bug fixes for the tldraw package. ([#4328](https://github.com/tldraw/tldraw/pull/4328))

[View release on GitHub](https://github.com/tldraw/tldraw/releases/tag/v2.4.3)

### v2.4.4

Bug fixes for the editor, sync, tldraw, and tlschema packages. ([#4352](https://github.com/tldraw/tldraw/pull/4352))

[View release on GitHub](https://github.com/tldraw/tldraw/releases/tag/v2.4.4)

### v2.4.5

Fixed unhandled promise rejection during strict mode in the editor. ([#4407](https://github.com/tldraw/tldraw/pull/4407))

[View release on GitHub](https://github.com/tldraw/tldraw/releases/tag/v2.4.5)

### v2.4.6

Performance improvements for rendering in the store and tldraw packages. ([#4434](https://github.com/tldraw/tldraw/pull/4434))

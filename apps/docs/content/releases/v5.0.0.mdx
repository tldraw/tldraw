---
title: 'v5.0.0'
created_at: 04/28/2026
updated_at: 04/28/2026
keywords:
  - changelog
  - release
  - v5.0
...
- Update hotkeys-js keyboard shortcut library from v3 to v4 for TypeScript support and better keyboard layout handling. ([#8372](https://github.com/tldraw/tldraw/pull/8372))
...
- Fix keyboard shortcuts that change styles not marking the change as a style update, causing subsequent shapes to use the wrong defaults. ([#8599](https://github.com/tldraw/tldraw/pull/8599))

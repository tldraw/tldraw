...
Fix a bug where the editor would remount in a loop if given custom assetUrls by memoizing asset URL merging. ([#6605](https://github.com/tldraw/tldraw/pull/6605))
...
Modify license flags message to display as a warning, and fix expired internal license verification. ([#6843](https://github.com/tldraw/tldraw/pull/6843))

...
- Fix `Cmd+Shift+V` doing nothing when the clipboard contained an image. It now falls back to pasting the image normally. ([#8490](https://github.com/tldraw/tldraw/pull/8490))

...
- Fix `tldraw` failing to resolve `@tldraw/state` and `@tldraw/tlschema` on package managers that enforce strict dependency isolation, such as pnpm. Both were imported but never declared in the package's manifest. ([#9762](https://github.com/tldraw/tldraw/pull/9762))

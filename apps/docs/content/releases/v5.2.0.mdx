---
title: v5.2.0
description: Faster freehand ink, a frame selection action, SDK-wide performance improvements, and breaking changes to the collaborator user-id types and Node support
author: tldraw
date: 07/01/2026
order: 0
status: published

...
The tldraw component's user interface will inherit its body font. If you'd like to use the same font that we use on [tldraw.com](https://tldraw.com), import the [Inter font](https://github.com/rsms/inter) from Google fonts:

```css
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700&display=swap');
```

The [Tldraw](?) component's other fonts are [loaded separately](#Static-Assets).

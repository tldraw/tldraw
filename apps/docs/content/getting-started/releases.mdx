...
- [v5.4](/releases/v5.4.0) - Over a hundred reliability fixes across undo history, tools, and shapes, a center align operation, a mounted-editors registry, and faster signals and store layers

...
You can use the tldraw SDK in commercial or non-commercial projects so long as you preserve the "Made with tldraw" watermark. If you purchase a business license, we will provide you with a license key that removes the watermark.

...
tldraw requires a license for commercial use (see [License terms](https://github.com/tldraw/tldraw/blob/main/LICENSE.md) for more details). Contact [sales@tldraw.com](mailto:sales@tldraw.com) to obtain a license for your company.

If you have a license, use the `licenseKey` prop in the [Tldraw](?) component to register the key and disable the "Made with tldraw" link.

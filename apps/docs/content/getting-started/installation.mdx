...
<CodeBlock
	code={{
		yarn: 'yarn add @tldraw/tldraw@beta',
		npm: 'npm install @tldraw/tldraw@beta',
		pnpm: 'pnpm add @tldraw/tldraw@beta',
	}}
/>
...
<CodeBlock
	code={{
		yarn: 'yarn add @tldraw/tldraw@canary',
		npm: 'npm install @tldraw/tldraw@canary',
		pnpm: 'pnpm add @tldraw/tldraw@canary',
	}}
/>

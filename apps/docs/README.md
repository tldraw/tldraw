...
1. As PRs merge to main, update `next.mdx` with release notes using the `/update-release-notes` command or `write-release-notes` skill
...
See `skills/write-release-notes/` for detailed formatting guidelines.

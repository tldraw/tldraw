...
export const Code: React.FC<{ files: { name: string; content: any }[] }> = ({ files }) => {
	...
	return (
		...
		>
			<TabList className="bg-zinc-900 text-sm text-zinc-400 shadow md:rounded-t-xl border-b border-zinc-700/50 px-5 md:px-4 gap-4 flex">
			...
			<TabPanels className="bg-zinc-900 text-sm text-white shadow md:rounded-b-xl overflow-x-auto px-5 md:px-4 py-4">

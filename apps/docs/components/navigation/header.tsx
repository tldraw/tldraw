...
export function Header() {
	...
	return (
		<header className="sticky top-0 w-full bg-white dark:bg-zinc-950 z-10">
			<nav className="w-full max-w-screen-2xl mx-auto px-5 h-14 md:h-[4.5rem] flex justify-between items-center text-zinc-800 dark:text-zinc-200 border-b border-zinc-100 dark:border-zinc-800 dark:md:border-transparent md:border-transparent">

...
export const RequestForm = () => {
	...
	return (
		<div>
			...
			{showForm && (
				<form className="pt-6 mt-6 border-t border-zinc-700/50 grid grid-cols-1 sm:grid-cols-2 gap-4">
					...
					<div className="sm:col-span-2 flex flex-col-reverse gap-2 sm:flex-row sm:justify-between">
						<div></div>
						<Button submit caption="Submit request" arrow="right" />
					</div>
				</form>
			)}
		</div>

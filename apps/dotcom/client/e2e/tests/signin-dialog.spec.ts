...
test.describe('TlaSignInDialog', () => {
  ...
  test('can sign in via email code using the custom dialog', async ({ homePage, editor, signInDialog }) => {
  ...
  test('requires legal acceptance on sign-up before continuing', async ({ homePage, signInDialog, page }) => {
  ...
  test('opt-in analytics persists to localStorage on sign-up', async ({ homePage, signInDialog, page }) => {

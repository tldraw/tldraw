 ...
 * server-side to files the user can access) — the same store that backs the in-document pins, here
 * unfiltered across every file.
 */
export function Component() {
	const app = useMaybeApp()
	const comments = useValue('comments', () => (app?.getComments() ?? []) as any[], [app])

...
test.describe('Workspace Browser Navigation', () => {
	test.describe('Folder Tree Navigation', () => {
		test('should display folder tree in sidebar', async ({ authenticatedPage, supabaseAdmin }) => {
	...
	test.describe('Archive Link', () => {
		test('should display archive link in sidebar', async ({ authenticatedPage, supabaseAdmin }) => {
			const page = authenticatedPage

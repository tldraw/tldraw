...
test.describe('Global Dashboard', () => {
	...
	// Workspace CRUD operations removed - these are comprehensively tested in workspace.spec.ts
	// Dashboard should only test dashboard-specific behavior like collapsible sections and recent documents

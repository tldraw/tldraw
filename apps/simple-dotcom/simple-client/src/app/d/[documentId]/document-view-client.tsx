		...
		<div className="flex h-screen flex-col">
				...
				<>
					<header className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-6 py-4 bg-white dark:bg-gray-900">
						<div className="flex items-center gap-4">
							...
							<h1 className=" font-bold text-gray-900 dark:text-gray-100">{document.name}</h1>
						</div>
					...
					<header className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-6 py-4">
						...
						{!userId && (
							<div className="flex gap-2">
								<Link
									href="/login"
									className="rounded-md border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 px-4 py-2  text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
								>
									Sign In
								</Link>
								<Link
			...
			<main className="flex flex-1 items-center justify-center bg-gray-100 dark:bg-gray-900">
				<div className="text-center">
					...
					<h2 className="mb-2  font-bold text-gray-900 dark:text-gray-100">tldraw Canvas</h2>
			...
			{showSharingModal && isMember && (
				<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70">
					<div className="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl">
						<h2 className="mb-4  font-bold text-gray-900 dark:text-gray-100">Sharing Settings</h2>
						...
						<div className="mt-6 flex justify-end gap-2">
							<button
								...
								disabled={isChangingSharing}
								className="rounded-md border border-gray-200 dark:border-gray-700 px-4 py-2  text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50"
							>
								Close
							</button>
						</div>

...
export const ErrorCodes = {
	...
	CANNOT_RENAME_PRIVATE_WORKSPACE: 'CANNOT_RENAME_PRIVATE_WORKSPACE',
	CANNOT_LEAVE_PRIVATE_WORKSPACE: 'CANNOT_LEAVE_PRIVATE_WORKSPACE',
...
export const getStatusCodeForError = (code: ErrorCode): number => {
	const mapping: Record<ErrorCode, number> = {
		...
		[ErrorCodes.CANNOT_RENAME_PRIVATE_WORKSPACE]: 403,
		[ErrorCodes.CANNOT_LEAVE_PRIVATE_WORKSPACE]: 403,
		...
		[ErrorCodes.DUPLICATE_WORKSPACE_NAME]: 422,

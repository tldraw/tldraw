import { Interaction, TLArrowShape, TLHandle, TLShapeId, TLShapePartial, Vec } from '@tldraw/editor'

export class TranslatingArrowBendInteraction extends Interaction<{
	shape: TLArrowShape
	handle: TLHandle
}> {

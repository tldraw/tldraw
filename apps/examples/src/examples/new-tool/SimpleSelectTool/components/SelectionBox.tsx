...
export const TldrawSelectionForeground = track(function TldrawSelectionForeground() {
	...
	let bounds = useValue('selection bounds', () => editor.getSelectionRotatedPageBounds(), [editor])
	const rotation = useValue('selection rotation', () => editor.getSelectionRotation(), [editor])
	...
	const state = currentTool.getState()
	...
	const showCropHandles =
		['pointing_crop_handle', 'crop_idle', 'crop_pointing'].includes(state.name) &&
		!isChangingStyle &&
		!isReadonlyMode

	const shouldDisplayControls =
		['idle', 'pointing_selection', 'pointing_shape', 'crop_idle'].includes(state.name) &&
		!isChangingStyle &&
		!isReadonlyMode

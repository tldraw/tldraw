...
`shouldBePrecise` makes the call, and receives the target shape, the release point, and whether Alt was held. Use the buttons to switch modes, then comment on the rectangle and the note to feel the difference.

...
Your **engines burn fuel** too — faster the deeper you sit in the well — and it drains as you fly; you refill by scooping the fuel cells scattered through the ring. A cell counts as taken the moment _any_ ship reaches it (again read straight off the synced cursors, so nothing new is synced), which means the whole room competes for one shared supply. Run dry and the engines cut out — **steering dies and your ship coasts on its last momentum while the sun's gravity curves it into a decaying fall**. The cursor is still the ship the whole time; it just loses control, and the world scrolls the star in to swallow you. The cursor-is-the-player constraint holds even through death.

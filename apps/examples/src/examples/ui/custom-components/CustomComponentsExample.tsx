...
/*
This example shows how to change the components that tldraw renders on the canvas via the
`components` prop. These include the background, grid, cursors, shape indicators, and more.
See `TLEditorComponents` for the full list.

...
Overlays are the canvas-drawn UI above shapes: selection handles, the brush rectangle, snap indicators, collaborator cursors. They render into a Canvas 2D context in page space rather than the React tree, which keeps them cheap during fast interactions.

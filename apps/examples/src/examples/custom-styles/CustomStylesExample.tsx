...
This example shows how to create your own custom styles to use with your shapes. It also shows
how to create a very simple ui for your styles. In this example, we create a custom style for
a card shape that lets the user apply a filter.
...
We also pass in the custom ui overrides. And render our FilterStyleUi component inside the Tldraw 
component. Check out FilterStyleUi.tsx to see how we render this Ui only when the user has selected
a shape that uses the custom style.

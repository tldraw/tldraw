...
import { quiverProxy } from './src/examples/editor-api/svg-to-freehand/vite-plugin-quiver-proxy'
...
export default defineConfig(({ mode }) => ({
	plugins: [spaFallbackPlugin(), react(), exampleReadmePlugin(), quiverProxy()],

...
async function addTestimonial() {
	try {
		...
		const testimonial = await client.create({
			_type: 'testimonial',
			quote:
				"tldraw's technology revolutionized how we deliver a high-quality foundational experience while maintaining flexibility and ease of use. This is where great docs live now.",
			author: 'Product Team',
				...
				caseStudySummaries: [
					{
						...
						heading: 'ClickUp',
						description:
							'How ClickUp uses tldraw to deliver a best-in-class whiteboarding experience to millions of users.',
					...
					},
					{
						...
						heading: 'Padlet',
						description:
							'How Padlet leverages tldraw to power collaborative learning experiences in education.',

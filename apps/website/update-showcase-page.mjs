      ...
      .set({
        projects: [
          ...
          },
          {
            ...
            description: 'An opinionated flowchart maker built with tldraw. Create professional flowcharts with a simple, focused interface.',
          ...
          },
          {
            ...
            _key: 'wireframes',
            name: 'Wireframe Tool',
            description: 'Create lo-fi wireframes and mockups quickly. Perfect for early-stage product design and brainstorming.',

...
import { getFaqSections, getSharedSections } from '@/sanity/queries'
...
export default async function FAQPage() {
	const [sanitySections, shared] = await Promise.all([getFaqSections(), getSharedSections()])

	const sections = sanitySections.map((section) => ({
	...
	return (
		<>
			<div className="mx-auto max-w-content border-b border-zinc-200 px-4 pb-8 pt-10 dark:border-zinc-800 sm:px-8 lg:pb-14 lg:pt-20">
				<h1 className="text-3xl font-semibold text-black dark:text-white lg:text-5xl">FAQ</h1>
				<p className="mt-4 text-sm leading-relaxed text-body dark:text-zinc-400 lg:mt-6">

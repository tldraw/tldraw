	...
	return (
		<div className="mt-12 w-full overflow-visible">
			<div className="flex flex-col gap-0 overflow-visible rounded-xl border border-zinc-200 bg-white shadow-lg dark:border-zinc-800 dark:bg-zinc-900 lg:flex-row">
				...
				<div className="relative flex min-h-[280px] flex-1 items-center justify-center overflow-visible border-t border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950 lg:min-h-[320px] lg:flex-[3] lg:border-l-0 lg:border-t-0">

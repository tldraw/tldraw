// Hardcoded careers page content matching https://tldraw.dev/careers
// Can be swapped for Sanity CMS fetches later.
...
export const careersContent = {
	...
	noOpenRoles: {
		...
		linkText: 'X',
		linkUrl: 'https://x.com/tldraw',
		afterLink: ' for updates.',
	},
}

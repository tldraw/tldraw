...
async function createShowcasePage() {
	try {
		...
		const result = await client.create({
			...
			showcaseSubtitle:
				'Across industries, teams are building world-class experiences with the tldraw SDK.',
			showAndTellTitle: 'Show and tell',
			showAndTellDescription:
				'Have you built something cool with tldraw? We would love to hear about it! Share your project with the community.',

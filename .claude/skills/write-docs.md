---
name: write-docs
description: Voice and style guide for writing tldraw SDK documentation. Use this when writing or reviewing docs in apps/docs/.
---

# Writing documentation

This is how we write SDK documentation at tldraw. Use it when writing new docs, reviewing existing content, or checking whether something sounds like us.
...
Short clarifying comparisons are fine—"shapes are just records (JSON objects)"—but don't reach for extended metaphors when plain language works.
...
AI writing often features multiple em dashes where a comma or period would be more natural. One em dash per paragraph is fine; several is a red flag.
...
Break up ideas when a sentence asks the reader to hold too much in their head at once.
...
Use blockquotes for important asides. Use `<Callout type="warning">` for warnings.

## Code examples

### Complete and runnable first

Your _first_ snippet should provide a full working example. Following examples can be fragments.
...
Use meaningful example data, not placeholders like `prop1: "value1"`.
...
Reference related concepts inline:

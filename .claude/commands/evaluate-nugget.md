---
name: evaluate-nugget
description: Evaluate a nugget draft and record scores in its frontmatter. Use this when reviewing drafts in documentation/nuggets/.
---
...
If scores are below 8 in any dimension, the draft should be improved using the improve-nugget skill.

...
Create `.claude/skills/docs-sprint/assets/prd.json` with the matrix structure:
...
Reset or create `.claude/skills/docs-sprint/assets/progress.txt` with fresh header.
